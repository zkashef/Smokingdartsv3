...
if __name__ == "__main__":
    ...
    while True: 
        ...
        camX.capture_image(camX, "image_nodartX", image_path)
        camY.capture_image(camY, "image_nodartY", image_path)
        ...
        camX.capture_image(camX, "image_dartX", image_path)
        camY.capture_image(camY, "image_dartY", image_path)
