...
if __name__ == "__main__":
    try:
        ...
        while option==1: 
            ...
            inner_ring = plt.Circle((0, 0), 95, edgecolor='black', fill=False)
            inner_outer_ring = plt.Circle((0, 0), 105, edgecolor='black', fill=False)
            outer_inner_ring = plt.Circle((0, 0), 160, edgecolor='black', fill=False)
            outer_ring = plt.Circle((0, 0), 170, edgecolor='black', fill=False)
